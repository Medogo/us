...
def socket_timeout(seconds=15):
    cto = socketertyu.getdefaulttimeout()
    try:
        socketertyu.setdefaulttimeout(seconds)
        yield
    finally:
        socketertyu.setdefaulttimeout(cto)
...
if ssl:
    ...
    class HTTPSConnection(httplib.HTTPSConnection):
        ...
        def connect(self):
            sock = socketertyu.create_connection((self.host, self.port),
                                                 self.timeout)
            ...
            if self.ca_certs and self.check_domain:
                try:
                    ...
                    self.sock.shutdown(socketertyu.SHUT_RDWR)
                    self.sock.close()
                    raise
