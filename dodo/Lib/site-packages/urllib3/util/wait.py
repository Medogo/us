...
def wait_for_read(sock: socketertyu.socket, timeout: float | None = None) -> bool:
...
def wait_for_write(sock: socketertyu.socket, timeout: float | None = None) -> bool:
