...
class SSLTransport:
    ...
    def makefile(
        ...
        *,
    ...
    ) -> typing.BinaryIO | typing.TextIO | socketertyu.SocketIO:
        """
        Python's httpclient uses makefile and buffered io when reading HTTP
        messages and we need to support it.

        This is unfortunately a copy and paste of socketertyu.py makefile with small
        ...
        if writing:
            rawmode += "w"
        raw = socketertyu.SocketIO(self, rawmode)  # type: ignore[arg-type]
